...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('leave_requests', function (Blueprint $table): void {
            $table->string('employee_signature')->nullable()->after('status');
            $table->string('approved_by_signature')->nullable()->after('employee_signature');
            $table->foreignId('approved_by_employee_id')->nullable()->after('approved_by_signature')->constrained('employees')->nullOnDelete();
        });
    }
