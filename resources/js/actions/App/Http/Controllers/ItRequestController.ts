 ...
 * @see app/Http/Controllers/ItRequestController.php:23
 * @route '/it-requests'
 */
 ...
 * @see app/Http/Controllers/ItRequestController.php:47
 ...
 * @see app/Http/Controllers/ItRequestController.php:69
 * @route '/it-requests'
 */
 ...
 * @see app/Http/Controllers/ItRequestController.php:118
 ...
 * @see app/Http/Controllers/ItRequestController.php:165
 * @route '/it-requests/{it_request}'
 */
 ...
 * @see app/Http/Controllers/ItRequestController.php:182
...
const ItRequestController = { index, create, store, show, edit, update, destroy, updateSignatures }
