...
export default function Index({
    ...
    jobPositions: PaginatedJobPositions;
    filters?: { search?: string };
}) {
    const { data: jobPositionList } = jobPositions;
    return (
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <Card>
                    <CardHeader className="flex flex-col gap-4 space-y-0 pb-2 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <CardTitle>Job Position Master List</CardTitle>
                            <CardDescription>
                                Manage job position codes, names, and
                                descriptions
                            </CardDescription>
                        </div>
                    ...
                    <CardContent>
                            ...
                            <table className="w-full text-sm">
                                ...
                                <tbody>
                                    {jobPositionList.length === 0 ? (
                                        ...
                                        jobPositionList.map((jobPosition) => (
                                            <tr
                                                key={jobPosition.id}
                                                            ...
                                                            <DialogContent>
                                                                ...
                                                                <DialogFooter>
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() =>
                                                                            router.delete(
                                                                                JobPositionController.destroy.url(
                                                                                    jobPosition.id
                                                                                )
                                                                            )
                                                                        }
                        ...
                        <DataTablePagination
                            links={jobPositions.links}
                            from={jobPositions.from}
                            to={jobPositions.to}
                            total={jobPositions.total}
                        />
                    </CardContent>
                </Card>
            </div>
