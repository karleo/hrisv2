...
export default function ItRequestPrint({
    ...
    return (
        <>
            ...
            <div className="it-print-root min-h-screen bg-[#d9d9d9] p-4 text-[#111a6b] print:min-h-screen print:flex print:flex-col print:bg-[#d9d9d9] print:p-1">
                ...
                <article className="it-print-article mx-auto w-full max-w-[920px] border border-neutral-400 bg-[#e6e6e6] p-10 print:mx-0 print:flex print:min-h-0 print:max-w-none print:flex-1 print:flex-col print:p-5">
