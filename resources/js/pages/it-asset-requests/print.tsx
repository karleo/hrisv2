...
export default function ItAssetRequestPrint({
    ...
    return (
        <>
            ...
            <div className="it-asset-print-root min-h-screen bg-white p-4 text-[#111a6b] print:min-h-screen print:flex print:flex-col print:bg-white print:p-1">
                ...
                <article className="it-asset-print-article mx-auto w-full max-w-[920px] border border-neutral-400 bg-white p-10 print:mx-0 print:flex print:min-h-0 print:max-w-none print:flex-1 print:flex-col print:p-5">
