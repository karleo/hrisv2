...
import { create, edit, index } from '@/routes/software';
...
export default function Index({
    ...
    const { data: softwareList } = software;
    return (
            ...
            <div className="flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4">
                <Card>
                    <CardHeader className="flex flex-col gap-4 space-y-0 pb-2 sm:flex-row sm:items-center sm:justify-between">
                        <div>
                            <CardTitle>Software Master List</CardTitle>
                            <CardDescription>
                                Manage software codes, names, and descriptions
                            </CardDescription>
                        </div>
                                        ...
                                        <tr>
                                            ...
                                            >
                                                {filters.search
                                                    ...
                                                    : 'No software found. Seed or create one to get started.'}
                                            </td>
                                        </tr>
                                    ) : (
                                                            ...
                                                            <DialogContent>
                                                                ...
                                                                <DialogFooter>
                                                                    ...
                                                                    <Button
                                                                        ...
                                                                        onClick={() =>
                                                                            router.delete(
                                                                                SoftwareController.destroy.url(
                                                                                    item.id
                                                                                )
                                                                            )
                                                                        }
